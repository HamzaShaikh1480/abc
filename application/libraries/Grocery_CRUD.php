...
class grocery_CRUD_Layout extends grocery_CRUD_Model_Driver
{
    ...
    protected function get_upload_file_input($field_info, $value)
    {
        ...
        $input = '<span class="fileinput-button qq-upload-button" id="upload-button-'.$unique.'" style="'.$uploader_display_none.'">
			...
			<input id="field-' . $field_info->name . '" class="hidden-upload-input" type="hidden" name="'.$field_info->name.'" value="'.$value.'" rel="'.$this->_unique_field_name($field_info->name).'" />
		</span>';
...
class Grocery_CRUD extends grocery_CRUD_States
{
    ...
    protected $default_language_path                = 'public/modules/grocerycrud/grocery_crud/languages';
    protected $default_config_path                    = 'public/modules/grocerycrud/grocery_crud/config';
    protected $default_assets_path                    = 'public/modules/grocerycrud/grocery_crud';
	...
	**/
    ...
    public function set_field_upload($field_name, $upload_dir = '', $allowed_file_types = '')
    {
        $upload_dir = !empty($upload_dir) && substr($upload_dir, -1, 1) == '/'
                        ...
                        : $upload_dir;
        $upload_dir = !empty($upload_dir) ? $upload_dir : 'public/modules/grocerycrud/uploads/files';
